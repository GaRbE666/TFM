...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void DashBack() //Method called by Animation Event in Armed-Roll-Backward
    {
        _rb.drag = 8f;
    ...
    public void DashForward() //Method called by Animation Event in Armed-Roll-Forward
    {
        _rb.drag = 8f;
